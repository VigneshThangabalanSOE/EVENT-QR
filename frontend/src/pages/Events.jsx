...
const Events = () => {
    ...
    const [generatingQR, setGeneratingQR] = useState(null); // track which event is generating
                                ...
                                <li key={event._id} className="py-4">
                                    ...
                                    <div className="flex gap-2 mt-2">
                                        <button
                                            ...
                                            className="bg-blue-500 text-white py-1 px-3 rounded-full hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                        >
                                            Scan
                                        </button>
                                        <button
                                            ...
                                            className="bg-purple-500 text-white py-1 px-3 rounded-full hover:bg-purple-600 focus:outline-none focus:ring-2 focus:ring-purple-500 disabled:opacity-50 disabled:cursor-not-allowed"
                                        >
                                            {generatingQR === event._id ? "Generating..." : "Generate QR"}
                                        </button>
                                    </div>
                                </li>
                            ))
